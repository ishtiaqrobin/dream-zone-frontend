...
const fakeChartData = [
  { month: "Jan", records: 20 },
  { month: "Feb", records: 35 },
  { month: "Mar", records: 50 },
  { month: "Apr", records: 40 },
  { month: "May", records: 60 },
  { month: "Jun", records: 80 },
];
                  ...
                  >
                    <div className="h-24 flex items-end justify-center">
                      <div
                        ...
                        style={{ height: `${d.records * 2}px` }}
                        title={`${d.records} records`}
                      ></div>
                    </div>
                    <div className="mt-2 text-sm">{d.records}</div>
                  </td>
                ))}
              </tr>
            </tbody>
